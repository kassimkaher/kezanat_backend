...
class BooksService {
    ...
    public async getDataOfBook(id: number) {
        ...
        try {
            ...
            //     for (const bookItem of bookItems.book_item) {
            ...
            // const data = await prisma.books.findUnique({ where: { id: id}, select: { id: true,
            //     title: true,
            //     date_of_release: true,
            //     owner: true,
            //     category: true,
            //     book_items: { select: { id: true, text: true, page: true, juzu: true, noveler_ids: true } } } });
